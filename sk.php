...
if(isset($res1['error'])){
    if (isset($res1['error']['type'])&&$res1['error']['type'] == 'invalid_request_error') {
            echo '<font color="FD0E35">DEAD<center> </span> <span><span><br>'.$sk.'</span></br><br>ʀᴇsᴘᴏɴsᴇ: RATE-LIMIT ❌</span><br>※';
        
}else{
        echo '<font color="#4D8C57">CHARGED<center><span><span></span><br><span><br>'.$sk.'<br></span><br>ʀᴇsᴘᴏɴsᴇ: 𝗦𝗞 𝗜𝗦 𝗟𝗜𝗩𝗘✅</br><br>※';
    }
    ...
    if(isset($res2['error'])){
        if (isset($res2['error']['type'])&&$res2['error']['type'] == "invalid_request_error") {
            echo '<font color="FD0E35">DEAD<center> </span> <span><span><br>'.$sk.'</span></br><br>ʀᴇsᴘᴏɴsᴇ: 𝗔𝗣𝗜 𝗘𝗫𝗣𝗜𝗥𝗘𝗗 ❌</span><br>※';
